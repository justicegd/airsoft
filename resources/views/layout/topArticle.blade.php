            ...
            <div class="col-md-12">
                ...
                <div class="owl-carousel owl-theme home-slider">
                    @foreach($topArticles as $topArticle)
                        <div>
                            <a href="{{route('article',[$topArticle->id,"ca_id"=>$topArticle->category_id])}}" class="a-block d-flex align-items-center height-lg" style="background-image: url('{{$topArticle->img}}'); ">
