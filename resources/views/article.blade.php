        ...
        <div class="post-content-body">
          ...
          <div class="row mb-5">
            <div class="col-md-12 mb-4 element-animate">
              <img src="view/images/img_7.jpg" alt="Image placeholder" class="img-fluid">
            </div>
            <div class="col-md-6 mb-4 element-animate">
              <img src="view/images/img_9.jpg" alt="Image placeholder" class="img-fluid">
            </div>
            <div class="col-md-6 mb-4 element-animate">
              <img src="view/images/img_11.jpg" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        ...
        <div class="sidebar-box">
          ...
          <div class="post-entry-sidebar">
            <ul>
              <li>
                <a href="">
                  <img src="view/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                  <div class="text">
